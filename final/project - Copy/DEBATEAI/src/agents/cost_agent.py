...
class CostAgent(BaseAgent):
    """Agent that analyzes financial implications"""
    
    def __init__(self):
        super().__init__(AgentRole.COST)
    
    def get_system_prompt(self) -> str:
        return AgentPrompts.COST
    
    def get_user_prompt(self, decision_input: DecisionInput) -> str:
        return f"""
        Please analyze this decision from a financial/cost perspective:
